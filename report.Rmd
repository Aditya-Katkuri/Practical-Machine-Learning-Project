...
In this project, we will use data from accelerometers on the belt, forearm, arm, and dumbell of 6 participants to predict the manner in which they did the exercise. This is the “classe” variable in the training set. We trained the **Random Forest** model using k-folds cross validation on the training set. We then predict using a validation set randomly selected from the training csv data to obtain the **accuracy** and **out of sample error rate**. After that we use it to predict 20 cases using the test csv set. 
...
# Creating and Testing the Random Forest Model
...
Github Repo: [Github](https://github.com/Aditya-Katkuri/Practical-Machine-Learning-Project)
